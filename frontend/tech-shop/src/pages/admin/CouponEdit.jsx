// src/pages/admin/CouponEdit.jsx
...
export default function CouponEdit() {
    ...
    const { updateCoupon, loading: updating } = useUpdateCoupon();
    ...
    useEffect(() => {
        if (coupon) {
            setFormData({
                ...
                expireDate: coupon.expireDate ? coupon.expireDate.slice(0, 16) : '',
        ...
        <div className="container mx-auto px-4 py-6 max-w-4xl">
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                    <Link to={`/admin/coupons/${couponId}`} className="p-2 hover:bg-slate-100 rounded-lg transition">
                        <ArrowLeft size={20} />
                    </Link>
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900">Chỉnh sửa mã giảm giá</h1>
                        <p className="text-sm text-slate-500 mt-1">Mã: {coupon.code}</p>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                    <Link to={`/admin/coupons/${couponId}`} className="px-4 py-2 border border-slate-200 rounded-lg hover:bg-slate-50 transition text-sm">
                        Hủy
                    </Link>
                    <button
                        type="submit"
            ...
            <form id="coupon-edit-form" onSubmit={handleSubmit} className="bg-white rounded-xl border border-slate-200 p-6 space-y-6">
